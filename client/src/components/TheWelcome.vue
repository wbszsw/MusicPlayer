...
console.log(1, msg);
console.log(2, count);
const emit = defineEmits(["updateMsg", "update:count"]);

function in2() {
  emit("updateMsg", msg.count++);
}
function in1() {
  console.log({ msg, count });
  console.log(isRef(count), isReactive(msg))
  console.log(isRef(msg), isReactive(count))
